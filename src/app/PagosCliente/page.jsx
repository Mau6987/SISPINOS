...
export default function OwnerPaymentsTable() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const url = `https://zneeyt2ar7.execute-api.us-east-1.amazonaws.com/dev/pagosPropietario/${ownerId}`
  ...
  const handleDownloadPDF = async (payment) => {
    try {
      const receiptData = {
        ...
        clientType: payment.usuario?.rol || "Propietario/Conductor",
      ...
      const generatePDFReceipt = (receiptData) => {
        ...
        doc.text("Comprobante de Pago - Propietario/Conductor", pageWidth / 2, 18, { align: "center" })
        ...
        yPos += 5
        doc.text("Este comprobante certifica el pago realizado por el propietario/conductor", margin + 2, yPos)
        yPos += 4
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Badge variant="outline">{selectedPayment.usuario?.rol || "Propietario/Conductor"}</Badge>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-600">
                        Este pago corresponde a los servicios de distribución de agua realizados por el
                        propietario/conductor en el sistema de Distribuidora de Agua Los Pinos.
                      </p>
                    </div>
                  </div>
                </CardContent>
