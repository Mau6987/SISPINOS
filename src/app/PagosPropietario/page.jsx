       ...
       <div className="bg-white rounded-lg shadow-md border border-gray-300 mb-6 overflow-hidden">
        <div className="px-6 py-4">
          <div className="flex items-center gap-3 justify-center">
            <div className="w-12 h-12 bg-gradient-to-br from-amber-600 to-amber-800 rounded-full flex items-center justify-center shadow-lg border border-gray-300">
              <svg className="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <path d="M7 12H9" strokeWidth="2"/>
                <path d="M15 12H17" strokeWidth="2"/>
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-black tracking-tight">Pagos del Propietario y Conductores</h1>
          </div>
        </div>
        <div className="h-1 bg-gradient-to-r from-amber-600 to-amber-800"></div>
      </div>
